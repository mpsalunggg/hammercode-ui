  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="text-center max-w-4xl mx-auto px-4">
        <h1 className="text-5xl md:text-8xl font-bold text-gray-900 mb-2">
          <span className="bg-white">HammerCode</span>
          <span className="text-blue-500 drop-shadow-lg">UI</span>
        </h1>
        <p className="text-lg text-gray-600">Created by HammerCode Community</p>
        <div className="mb-4">
          <p className="text-lg text-gray-600">
            Beautiful, accessible, and customizable React components for modern
            web applications
          </p>
        </div>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="https://www.npmjs.com/package/@hammercode/ui"
            target="_blank"
          ...
          <Link
            href="https://github.com/mpsalunggg/hammercode-ui"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Button
